					...
					<form action="/UpdateCompany" method="post"
						...
						<div class="form-group">
							<label for="password">새 비밀번호</label> <input type="password"
								class="form-control" id="password" name="companyPassword"
						...
						<div class="form-group">
							<label for="phone">사업장 전화번호</label> <input type="text"
								...
								value="${company.phone}" readonly style="display: none;">
							<input type="text" class="form-control" id="formattedPhone"
								oninput="formatAsPhoneNumber(this)" maxlength="13"
								value="${company.phone}" placeholder="전화번호를 입력하세요.">
						</div>
						<div class="form-group">
							<label for="exteriorImage">외관 이미지</label> <input type="file"
								class="form-control" id="exteriorImage" name="exteriorImage">
						</div>
						<!-- 내관 이미지 -->
						<div class="form-group">
							<label for="interiorImage">내관 이미지</label> <input type="file"
								class="form-control" id="interiorImage" name="interiorImage">
						</div>
						<!-- 사업장 설명 -->
						<div class="form-group">
						...
						<div class="form-group">
							<label for="closedDays">휴무일</label> <input type="text"
								...
								value="${company.closedDays}">
						</div>
						<!-- 브레이크 타임 -->
						<div class="form-group">
							<label for="breakTime">브레이크 타임</label> <input type="text"
								class="form-control" id="breakTime" name="breakTime"
								value="${company.breakTime}">
						</div>
						<button type="submit" class="btn btn-primary" id="submit">수정
							및 추가하기</button>
					</form>
